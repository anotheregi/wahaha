                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable1" class="display" style="width:100%">
                                                ...
                                                <tbody>
                                                    <?php foreach ($conversations->result() as $conv) : ?>
                                                        <tr>
                                                            <td><?= $conv->contact ?></td>
                                                            <td><?= $conv->message_count ?> messages</td>
                                                            <td><small><?= date('d/m/Y H:i', strtotime($conv->last_message)) ?></small></td>
                                                            <td>
                                                                <a href="<?= base_url('report/chat_history/' . $conv->contact) ?>" class="btn btn-primary btn-sm">View Chat</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach ?>
                                                </tbody>
