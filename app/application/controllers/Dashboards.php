  ...
  public function index()
  {
    if ($this->input->post()) {
      ...
      $data = [
        ...
        'blast_pending' => $this->db->get_where('blast', ['status' => 'pending', 'make_by' => $this->session->userdata('id_login')])->num_rows(),
        'blast_gagal' => $this->db->get_where('blast', ['status' => 'gagal', 'make_by' => $this->session->userdata('id_login')])->num_rows(),
        'blast_terkirim' => $this->db->get_where('blast', ['status' => 'terkirim', 'make_by' => $this->session->userdata('id_login')])->num_rows()
      ];
      view("home", $data);
    }
  }
